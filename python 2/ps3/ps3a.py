...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while calculate_handlen(hand) > 0:
        ...
        userWord = raw_input("Enter a word or a '.' to indicate that you are finished: ")
        if userWord == ".":
            ...
            if not isValid:
                ...
                point = get_word_score(userWord, original_handlen)
                total += point
                print "'%s' earned %d points. Total: %d points" % (userWord, point, total)
                hand = update_hand(hand, userWord)
    print "You ran out of letters. Total score: %d points." % total
